...
// حذف محصول و آیتم‌های سفارش مرتبط
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    $delete_id = intval($_GET['delete']);
    $conn->query("DELETE FROM order_items WHERE product_id = $delete_id");
...
<body>
    ...
    <div class="container py-5" data-aos="fade-up">
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap">
            ...
            <a href="add_product.php" class="btn btn-success add-product-btn"><i class="fas fa-plus"></i> افزودن محصول جدید</a>
        </div>
                        ...
                        while ($product = $products->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="products.php?delete=<?php echo $product['id']; ?>" class="btn btn-danger btn-sm delete-btn" onclick="return confirm('آیا از حذف این محصول مطمئن هستید؟')"><i class="fas fa-trash"></i> حذف</a>
                                </td>
                            </tr>
                        <?php endwhile;
                    else: ?>
