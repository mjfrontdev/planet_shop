...
if (isset($_POST['reply_id']) && isset($_POST['admin_reply'])) {
    ...
    $conn->query("UPDATE tickets SET admin_reply='".$conn->real_escape_string($reply)."', status='answered' WHERE id=$id");
    header('Location: tickets.php');
    exit();
}
...
<head>
    ...
    <style>
        ...
        .ticket-reply-box { background: #e8f5e9; border-radius: 12px; padding: 1rem; margin-top: 1rem; }
        .ticket-message { background: #fff; border-radius: 12px; padding: 1rem; margin-bottom: 0.5rem; }
    </style>
</head>
<body>
    ...
    <div class="container py-5" data-aos="fade-up">
        ...
        <div class="table-responsive">
            <table class="table table-bordered align-middle">
                ...
                <tbody>
                <?php if ($tickets && $tickets->num_rows > 0): $i=1; while($ticket = $tickets->fetch_assoc()): ?>
                    <tr>
                        <td><?php echo $i++; ?></td>
                        ...
                        <td>
                            ...
                            <form method="POST" action="tickets.php" class="d-inline">
                    ...
                    <tr class="ticket-details-row" id="ticket-details-<?php echo $ticket['id']; ?>" style="display:none;">
                        <td colspan="7">
                            ...
                            <?php elseif($ticket['status']!='closed'): ?>
                                <form method="POST" action="tickets.php" class="ticket-reply-form mt-3">
                ...
                <?php endwhile; else: ?>
                    <tr><td colspan="7" class="text-center">تیکتی یافت نشد.</td></tr>
                <?php endif; ?>
                </tbody>
            </table>
        </div>
